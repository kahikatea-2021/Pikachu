...
function Battle() {
    ...
    lg:text-xl
    md:text-md
    sm:text-sm'> Pokemon Battle Simulator</h1>
            <div className='pl-2 pr-2 bg-gray-200 flex flex-nowrap content-center items-center justify-center'>
                ...
                <div className="mt-2 mb-2 border-2 border-black rounded-xl grid grid-cols-3 gap-8">
                    ...
                    <div >
                        ...
                        <img src={(process.env.PUBLIC_URL + `/images/front_sprites/Spr_1y_${pokemonData.Pokemon[pokemon2].id}.png`)} />
                    </div>
                    <div></div>
                    <div className='flex flex-nowrap content-center items-center justify-center'>
                        <Link to='/Battle'><div>Random</div></Link>
                    </div>
                    <div></div>
                    <div className='pl-2'>
                        {pokemonData.Pokemon[pokemon1].name}
                        <img src={(process.env.PUBLIC_URL + `/images/back_sprites/Spr_b_g1_${pokemonData.Pokemon[pokemon1].id}.webp`)} /></div>
                    <div></div>
                    <div></div>                    
                    <div className='flex-auto p-2 rounded-xl bg-red-400'><p className='text-sm text-white'>Player 1: </p><select className='w-16 text-xs
        border-0 focus:outline-none'>
                    ...
                    <div className='flex flex-nowrap content-center items-center justify-center'>
                        ...
                        <Link to='/Battle'><div><img src={(process.env.PUBLIC_URL + '/images/Pokeball_tiny.webp')} />  Fight</div></Link>
                    </div>
                    <div className='flex-auto p-2 rounded-xl bg-blue-400'> <p className='text-sm text-white'>Player 2: </p><select className='w-16 text-xs
        border-0 focus:outline-none'>
                        <option value="NA">Jared</option>
                        <option value="EUW">Johann</option>
                        <option value="EUN">Johnny</option>
